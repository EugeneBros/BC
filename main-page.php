		...
		<li class="swiper-slide slide1 item" style="background: url('<?php bloginfo('template_url') ?>/src/img/slider/slide1.jpg') no-repeat center center; background-size: cover;">
			<div class="container">
				<div class="slider-content">
					...
					<p class="parallax-text" data-swiper-parallax="-40%">Раскрой свой потенциал вместе с BANDSCLUBTM.</p><a class="btn btn-def parallax-text" href="#" data-swiper-parallax="-30%">ВЫБРАТЬ СВОЙ НАБОР</a>
		...
		<li class="swiper-slide slide2 item" style="background: url('<?php bloginfo('template_url') ?>/src/img/slider/slide2.jpg') no-repeat center center; background-size: cover;">
			<div class="container">
				<div class="slider-content col-md-offset-4">
					...
					<p class="parallax-text-right" data-swiper-parallax="50%">тренируйся со стилем - эффектность и эффективность в одном наборе.</p><a class="btn btn-def parallax-text-right" href="#" data-swiper-parallax="50%">перейти к покупке</a>
		...
		<li class="swiper-slide slide3 item" style="background: url('<?php bloginfo('template_url') ?>/src/img/slider/slide3.jpg') no-repeat center center; background-size: cover;">
			<div class="container">
				<div class="slider-content">
					...
					<p class="parallax-text-left" data-swiper-parallax="50%">Никаких ограничений. <br> Никаких  оправданий. <br> Никаких барьеров.</p><a class="btn btn-def parallax-text-left" href="#" data-swiper-parallax="50%">ВЫБРАТЬ свой НАБОР</a>
